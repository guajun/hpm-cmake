...
if(NOT EXISTS "${_hpm_stamp}")
  message(FATAL_ERROR "Run ./.hpm-cmake/sync.ps1 before configuring this project.")
endif()
...
if(NOT _hpm_synced_hash STREQUAL _hpm_lock_hash)
  message(FATAL_ERROR "Dependency lock changed. Run ./.hpm-cmake/sync.ps1, then configure with --fresh.")
endif()
